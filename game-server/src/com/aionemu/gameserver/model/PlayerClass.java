...
public enum PlayerClass implements L10n {
    ...
    PlayerClass(Integer classId, int nameId, boolean isStartingClass, int power, int health, int agility, int accuracy, int knowledge, int will, int healthMultiplier, int willMultiplier, int magicalCriticalResist) {
        ...
        this.power = 9999;//power;
        this.health = 9999;//health;
        this.agility = 9999;//agility;
        this.accuracy = 9999;//accuracy;
        this.knowledge = 9999;//knowledge;
        this.will = 9999;//will;
     ...
     * @return PlayerClass that matches the given classId. If there isn't one,
     * {@link IllegalArgumentException} is being thrown.
     */
    ...
    public boolean isPhysicalClass() {
        return switch (this) {
            case WARRIOR, GLADIATOR, TEMPLAR, SCOUT, ASSASSIN, RANGER, CHANTER ->
                true;
            default ->
                false;
        };
    ...
    public String getIconImage() {
        return switch (this) {
            case WARRIOR ->
                "textures/ui/EMBLEM/icon_emblem_warrior.dds";
            case GLADIATOR ->
                "textures/ui/EMBLEM/icon_emblem_fighter.dds";
            case TEMPLAR ->
                "textures/ui/EMBLEM/icon_emblem_knight.dds";
            case SCOUT ->
                "textures/ui/EMBLEM/icon_emblem_scout.dds";
            case ASSASSIN ->
                "textures/ui/EMBLEM/icon_emblem_assassin.dds";
            case RANGER ->
                "textures/ui/EMBLEM/icon_emblem_ranger.dds";
            case MAGE ->
                "textures/ui/EMBLEM/icon_emblem_mage.dds";
            case SORCERER ->
                "textures/ui/EMBLEM/icon_emblem_wizard.dds";
            case SPIRIT_MASTER ->
                "textures/ui/EMBLEM/icon_emblem_elementalist.dds";
            case PRIEST ->
                "textures/ui/EMBLEM/icon_emblem_cleric.dds"; // cleric and priest images are switched in client
            case CLERIC ->
                "textures/ui/EMBLEM/icon_emblem_priest.dds"; // cleric and priest images are switched in client
            case CHANTER ->
                "textures/ui/EMBLEM/icon_emblem_chanter.dds";
            case ENGINEER ->
                "textures/ui/EMBLEM/Icon_emblem_Engineer.dds";
            case RIDER ->
                "textures/ui/EMBLEM/Icon_emblem_Rider.dds";
            case GUNNER ->
                "textures/ui/EMBLEM/Icon_emblem_Gunner.dds";
            case ARTIST ->
                "textures/ui/EMBLEM/Icon_emblem_Artist.dds";
            case BARD ->
                "textures/ui/EMBLEM/Icon_emblem_Bard.dds";
        };
    }
